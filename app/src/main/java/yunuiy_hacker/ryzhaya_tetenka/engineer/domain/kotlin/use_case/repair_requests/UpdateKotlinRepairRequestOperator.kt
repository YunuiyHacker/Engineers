...
class UpdateKotlinRepairRequestOperator(private val kotlinRepairRequestsApi: KotlinRepairRequestsApi) {
    suspend operator fun invoke(repairRequest: RepairRequest): RepairRequest? {
        return kotlinRepairRequestsApi.putRepairRequest(repairRequest = repairRequest)
    }
}